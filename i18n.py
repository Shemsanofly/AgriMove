...
MESSAGES = {
    "en": {
        ...
        "payment_escrow_success": "Payment secured in escrow. SMS notifications sent via Africa's Talking sandbox.",
        "payment_release_success": "Payment released to farmer. SMS notifications sent via Africa's Talking sandbox.",
        "admin_heading": "Admin",
    ...
    "sw": {
        ...
        "payment_escrow_success": "Malipo yamewekwa dhamana. Arifa za SMS zimetumwa kupitia sandbox ya Africa's Talking.",
        "payment_release_success": "Malipo yameachiwa kwa mkulima. Arifa za SMS zimetumwa kupitia sandbox ya Africa's Talking.",
